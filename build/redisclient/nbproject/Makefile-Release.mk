...
LDLIBSOPTIONS=-lboost_system -lrt -lboost_thread -Wl,-rpath ../redis4cpp/../redisclient/dist/Release/GNU-Linux-x86 -L../redis4cpp/../redisclient/dist/Release/GNU-Linux-x86 -lredis4cpp

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${TESTDIR}/TestFiles/f1

${TESTDIR}/TestFiles/f1: ../redis4cpp/../redisclient/dist/Release/GNU-Linux-x86/libredis4cpp.so
