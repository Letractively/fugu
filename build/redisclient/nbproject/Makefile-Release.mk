...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/redisclient: ../redis4cpp/dist/Release/GNU-Linux-x86/libredis4cpp.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/redisclient: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/redisclient ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/_ext/526502843/main.o: ../../src/redisclient/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/526502843
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../src -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/526502843/main.o ../../src/redisclient/main.cpp
